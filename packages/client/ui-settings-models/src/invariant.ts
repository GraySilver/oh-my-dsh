/**
 * Package-owned invariant companion for `@graysilver/oh-my-dsh-models`.
 * @module @graysilver/oh-my-dsh-models/invariant
 */
...
const PACKAGE_NAME = '@graysilver/oh-my-dsh-models'
