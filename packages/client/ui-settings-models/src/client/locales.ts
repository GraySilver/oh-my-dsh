...
export const en = {
  ...
  onboardingTitle: 'Connect DeepSeek',
  onboardingDescription: 'Your key is tested against DeepSeek before it is saved locally. Oh My DSH never sends it anywhere else.',
  onboardingLater: 'Configure later',
  onboardingSave: 'Save and continue',
  onboardingSaving: 'Saving…',
  onboardingTestSave: 'Test, save, and continue',
  onboardingTesting: 'Testing connection…',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  onboardingTitle: '连接 DeepSeek',
  onboardingDescription: 'API 密钥会先直接连接 DeepSeek 测试，通过后才保存在本机；Oh My DSH 不会将它发送到其他地方。',
  onboardingLater: '稍后配置',
  onboardingSave: '保存并继续',
  onboardingSaving: '保存中…',
  onboardingTestSave: '测试连接、保存并继续',
  onboardingTesting: '正在测试连接…',
